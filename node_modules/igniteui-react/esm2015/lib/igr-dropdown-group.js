...
import { IgcDropdownGroupComponent, defineComponents } from "igniteui-webcomponents";
...
*/
export class IgrDropdownGroup extends React.Component {
    ...
    render() {
        ...
        let div = React.createElement("igc-dropdown-group", Object.assign(Object.assign({}, nativeProps), { ref: this._getMainRef, id: this.props.id, class: this.props.className, style: style, children: children }));
        return div;
    }
    _getMainRef(ref) {
        this._elRef = ref;
