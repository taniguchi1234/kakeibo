...
*/
export class IgrList extends React.Component {
    ...
    render() {
        ...
        let div = React.createElement("igc-list", Object.assign(Object.assign({}, nativeProps), { ref: this._getMainRef, id: this.props.id, class: this.props.className, style: style, children: children }));
        return div;
    }
    _getMainRef(ref) {
        this._elRef = ref;
