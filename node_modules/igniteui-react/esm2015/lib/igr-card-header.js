...
import { IgcCardHeaderComponent, defineComponents } from "igniteui-webcomponents";
...
*/
export class IgrCardHeader extends React.Component {
    ...
    render() {
        ...
        let div = React.createElement("igc-card-header", Object.assign(Object.assign({}, nativeProps), { ref: this._getMainRef, id: this.props.id, class: this.props.className, style: style, children: children }));
        return div;
    }
    _getMainRef(ref) {
        this._elRef = ref;
