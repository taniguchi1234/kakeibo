 ...
 * interactive surface.
*/
export declare class IgrRipple<P extends IIgrRippleProps = IIgrRippleProps> extends React.Component<P & Omit<React.HTMLAttributes<HTMLElement>, keyof P>, {}> {
    ...
    get i(): Ripple; /**
                                 * @hidden
                                 */
    static _createFromInternal(internal: any): IgrRipple;
