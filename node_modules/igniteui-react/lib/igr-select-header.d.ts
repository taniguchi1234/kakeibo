...
*/
export declare class IgrSelectHeader<P extends IIgrSelectHeaderProps = IIgrSelectHeaderProps> extends React.Component<P & Omit<React.HTMLAttributes<HTMLElement>, keyof P>, {}> {
    protected createImplementation(): SelectHeader;
    ...
    get i(): SelectHeader; /**
                                 * @hidden
                                 */
    static _createFromInternal(internal: any): IgrSelectHeader;
...
export interface IIgrSelectHeaderProps {
