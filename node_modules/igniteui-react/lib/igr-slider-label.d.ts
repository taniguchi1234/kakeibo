...
export declare class IgrSliderLabel<P extends IIgrSliderLabelProps = IIgrSliderLabelProps> extends React.Component<P & Omit<React.HTMLAttributes<HTMLElement>, keyof P>, {}> {
    protected createImplementation(): SliderLabel;
    ...
    get i(): SliderLabel; /**
                                 * @hidden
                                 */
    static _createFromInternal(internal: any): IgrSliderLabel;
...
export interface IIgrSliderLabelProps {
