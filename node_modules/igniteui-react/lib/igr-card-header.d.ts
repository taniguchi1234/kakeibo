...
*/
export declare class IgrCardHeader<P extends IIgrCardHeaderProps = IIgrCardHeaderProps> extends React.Component<P & Omit<React.HTMLAttributes<HTMLElement>, keyof P>, {}> {
    protected createImplementation(): CardHeader;
    ...
    get i(): CardHeader; /**
                                 * @hidden
                                 */
    static _createFromInternal(internal: any): IgrCardHeader;
...
export interface IIgrCardHeaderProps {
