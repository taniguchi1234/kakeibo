...
*/
export declare class IgrRatingSymbol<P extends IIgrRatingSymbolProps = IIgrRatingSymbolProps> extends React.Component<P & Omit<React.HTMLAttributes<HTMLElement>, keyof P>, {}> {
    protected createImplementation(): RatingSymbol;
    ...
    get i(): RatingSymbol; /**
                                 * @hidden
                                 */
    static _createFromInternal(internal: any): IgrRatingSymbol;
...
export interface IIgrRatingSymbolProps {
