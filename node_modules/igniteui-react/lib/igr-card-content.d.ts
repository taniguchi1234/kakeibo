...
*/
export declare class IgrCardContent<P extends IIgrCardContentProps = IIgrCardContentProps> extends React.Component<P & Omit<React.HTMLAttributes<HTMLElement>, keyof P>, {}> {
    protected createImplementation(): CardContent;
    ...
    get i(): CardContent; /**
                                 * @hidden
                                 */
    static _createFromInternal(internal: any): IgrCardContent;
...
export interface IIgrCardContentProps {
