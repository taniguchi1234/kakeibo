...
*/
export declare class IgrDropdownGroup<P extends IIgrDropdownGroupProps = IIgrDropdownGroupProps> extends React.Component<P & Omit<React.HTMLAttributes<HTMLElement>, keyof P>, {}> {
    protected createImplementation(): DropdownGroup;
    ...
    get i(): DropdownGroup; /**
                                 * @hidden
                                 */
    static _createFromInternal(internal: any): IgrDropdownGroup;
...
export interface IIgrDropdownGroupProps {
