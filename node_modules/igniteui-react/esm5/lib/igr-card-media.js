...
var IgrCardMedia = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    IgrCardMedia.prototype.render = function () {
        ...
        var div = React.createElement("igc-card-media", __assign(__assign({}, nativeProps), { ref: this._getMainRef, id: this.props.id, class: this.props.className, style: style, children: children }));
        return div;
    };
