...
var IgrSelectHeader = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgrSelectHeader, _super);
    ...
    IgrSelectHeader.prototype.render = function () {
        ...
        var div = React.createElement("igc-select-header", __assign(__assign({}, nativeProps), { ref: this._getMainRef, id: this.props.id, class: this.props.className, style: style, children: children }));
        return div;
    };
