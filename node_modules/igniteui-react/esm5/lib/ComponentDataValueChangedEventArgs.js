...
var ComponentDataValueChangedEventArgs = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ComponentDataValueChangedEventArgs, _super);
    ...
    ComponentDataValueChangedEventArgs.$t = markType(ComponentDataValueChangedEventArgs, 'ComponentDataValueChangedEventArgs');
    return ComponentDataValueChangedEventArgs;
}(Base));
export { ComponentDataValueChangedEventArgs };
