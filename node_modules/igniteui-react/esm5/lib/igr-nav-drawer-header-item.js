...
var IgrNavDrawerHeaderItem = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgrNavDrawerHeaderItem, _super);
    ...
    IgrNavDrawerHeaderItem.prototype.render = function () {
        ...
        var div = React.createElement("igc-nav-drawer-header-item", __assign(__assign({}, nativeProps), { ref: this._getMainRef, id: this.props.id, class: this.props.className, style: style, children: children }));
        return div;
    };
