...
import { NamePatcher, getModifiedProps, isValidProp, ensureBool, toSpinal, initializePropertiesFromCss, interfaceToInternal } from "igniteui-react-core";
...
var IgrIcon = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    IgrIcon.prototype.render = function () {
        ...
        var div = React.createElement("igc-icon", __assign(__assign({}, nativeProps), { ref: this._getMainRef, id: this.props.id, class: this.props.className, style: style, children: children }));
        return div;
    };
    ...
    IgrIcon.prototype.setIconRef = function (name, collection, icon) {
        this.i.l(name, collection, (icon == null ? null : interfaceToInternal(icon, function () { return new IconMeta(); })));
    };
    return IgrIcon;
}(React.Component));
export { IgrIcon };
