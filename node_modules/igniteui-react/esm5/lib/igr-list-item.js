...
var IgrListItem = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    IgrListItem.prototype.render = function () {
        ...
        var div = React.createElement("igc-list-item", __assign(__assign({}, nativeProps), { ref: this._getMainRef, id: this.props.id, class: this.props.className, style: style, children: children }));
        return div;
    };
