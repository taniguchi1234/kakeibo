...
var DropdownItemComponentEventArgs = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(DropdownItemComponentEventArgs, _super);
    ...
    DropdownItemComponentEventArgs.$t = markType(DropdownItemComponentEventArgs, 'DropdownItemComponentEventArgs');
    return DropdownItemComponentEventArgs;
}(Base));
export { DropdownItemComponentEventArgs };
