...
var IgrRatingSymbol = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgrRatingSymbol, _super);
    ...
    IgrRatingSymbol.prototype.render = function () {
        ...
        var div = React.createElement("igc-rating-symbol", __assign(__assign({}, nativeProps), { ref: this._getMainRef, id: this.props.id, class: this.props.className, style: style, children: children }));
        return div;
    };
