...
var ActiveStepChangingArgsEventArgs = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(ActiveStepChangingArgsEventArgs, _super);
    ...
    ActiveStepChangingArgsEventArgs.$t = markType(ActiveStepChangingArgsEventArgs, 'ActiveStepChangingArgsEventArgs');
    return ActiveStepChangingArgsEventArgs;
}(Base));
export { ActiveStepChangingArgsEventArgs };
