...
var FloatingPaneResizeMoveEventArgs = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(FloatingPaneResizeMoveEventArgs, _super);
    ...
    FloatingPaneResizeMoveEventArgs.$t = markType(FloatingPaneResizeMoveEventArgs, 'FloatingPaneResizeMoveEventArgs');
    return FloatingPaneResizeMoveEventArgs;
}(Base));
export { FloatingPaneResizeMoveEventArgs };
