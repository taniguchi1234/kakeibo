...
var TabHeaderConnectionEventArgs = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(TabHeaderConnectionEventArgs, _super);
    ...
    TabHeaderConnectionEventArgs.$t = markType(TabHeaderConnectionEventArgs, 'TabHeaderConnectionEventArgs');
    return TabHeaderConnectionEventArgs;
}(Base));
export { TabHeaderConnectionEventArgs };
