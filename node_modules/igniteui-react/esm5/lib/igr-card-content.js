...
var IgrCardContent = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgrCardContent, _super);
    ...
    IgrCardContent.prototype.render = function () {
        ...
        var div = React.createElement("igc-card-content", __assign(__assign({}, nativeProps), { ref: this._getMainRef, id: this.props.id, class: this.props.className, style: style, children: children }));
        return div;
    };
