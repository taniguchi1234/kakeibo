...
var IgrTabPanel = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    IgrTabPanel.prototype.render = function () {
        ...
        var div = React.createElement("igc-tab-panel", __assign(__assign({}, nativeProps), { ref: this._getMainRef, id: this.props.id, class: this.props.className, style: style, children: children }));
        return div;
    };
