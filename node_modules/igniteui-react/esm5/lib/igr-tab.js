...
import { IgcTabComponent, defineComponents } from "igniteui-webcomponents";
...
var IgrTab = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    IgrTab.prototype.render = function () {
        ...
        var div = React.createElement("igc-tab", __assign(__assign({}, nativeProps), { ref: this._getMainRef, id: this.props.id, class: this.props.className, style: style, children: children }));
        return div;
    };
