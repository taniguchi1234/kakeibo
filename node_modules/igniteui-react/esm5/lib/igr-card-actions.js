...
var IgrCardActions = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgrCardActions, _super);
    ...
    IgrCardActions.prototype.render = function () {
        ...
        var div = React.createElement("igc-card-actions", __assign(__assign({}, nativeProps), { ref: this._getMainRef, id: this.props.id, class: this.props.className, style: style, children: children }));
        return div;
    };
