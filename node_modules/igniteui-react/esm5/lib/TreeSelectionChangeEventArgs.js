...
var TreeSelectionChangeEventArgs = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(TreeSelectionChangeEventArgs, _super);
    ...
    TreeSelectionChangeEventArgs.$t = markType(TreeSelectionChangeEventArgs, 'TreeSelectionChangeEventArgs');
    return TreeSelectionChangeEventArgs;
}(Base));
export { TreeSelectionChangeEventArgs };
