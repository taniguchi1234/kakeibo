...
var IgrCard = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    IgrCard.prototype.render = function () {
        ...
        var div = React.createElement("igc-card", __assign(__assign({}, nativeProps), { ref: this._getMainRef, id: this.props.id, class: this.props.className, style: style, children: children }));
        return div;
    };
