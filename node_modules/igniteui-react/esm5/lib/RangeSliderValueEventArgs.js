...
var RangeSliderValueEventArgs = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(RangeSliderValueEventArgs, _super);
    ...
    RangeSliderValueEventArgs.$t = markType(RangeSliderValueEventArgs, 'RangeSliderValueEventArgs');
    return RangeSliderValueEventArgs;
}(Base));
export { RangeSliderValueEventArgs };
