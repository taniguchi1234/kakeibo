...
var IgrSliderLabel = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgrSliderLabel, _super);
    ...
    IgrSliderLabel.prototype.render = function () {
        ...
        var div = React.createElement("igc-slider-label", __assign(__assign({}, nativeProps), { ref: this._getMainRef, id: this.props.id, class: this.props.className, style: style, children: children }));
        return div;
    };
