...
var IgrBadge = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    IgrBadge.prototype.render = function () {
        ...
        var div = React.createElement("igc-badge", __assign(__assign({}, nativeProps), { ref: this._getMainRef, id: this.props.id, class: this.props.className, style: style, children: children }));
        return div;
    };
