...
var IgrCardHeader = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgrCardHeader, _super);
    ...
    IgrCardHeader.prototype.render = function () {
        ...
        var div = React.createElement("igc-card-header", __assign(__assign({}, nativeProps), { ref: this._getMainRef, id: this.props.id, class: this.props.className, style: style, children: children }));
        return div;
    };
