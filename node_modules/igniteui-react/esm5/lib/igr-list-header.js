...
var IgrListHeader = /** @class */ /*@__PURE__*/ (function (_super) {
    __extends(IgrListHeader, _super);
    ...
    IgrListHeader.prototype.render = function () {
        ...
        var div = React.createElement("igc-list-header", __assign(__assign({}, nativeProps), { ref: this._getMainRef, id: this.props.id, class: this.props.className, style: style, children: children }));
        return div;
    };
