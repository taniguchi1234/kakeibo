 ...
 */
const patchBrowser = () => {
    const importMeta = (typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('igniteui-dockmanager.cjs.js', document.baseURI).href));
    const opts = {};
    if (importMeta !== '') {
...
//# sourceMappingURL=igniteui-dockmanager.cjs.js.map