...
export declare class IgcDockManagerService {
  ...
  keyboardDockPane: IgcContentPane;
  ...
  private pointInBoundaries;
  dragPaneMove(clientX: number, clientY: number): boolean;
  dragPaneEnd(): boolean;
  private emitDragOverEvent;
  private dragOver;
  ...
  getDropShadowRect(dockingPosition?: IgcDockingIndicatorPosition, dockingDirection?: string): DOMRect;
