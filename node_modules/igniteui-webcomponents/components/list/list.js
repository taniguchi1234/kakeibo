...
let IgcListComponent = IgcListComponent_1 = class IgcListComponent extends LitElement {
    static register() {
        registerComponent(IgcListComponent_1, IgcListItemComponent, IgcListHeaderComponent);
    }
    constructor() {
        super();
