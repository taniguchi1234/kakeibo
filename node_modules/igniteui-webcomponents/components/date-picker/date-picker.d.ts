...
declare const IgcDatePickerComponent_base: import("../common/mixins/constructor.js").Constructor<import("../common/mixins/forms/types.js").FormRequiredInterface & import("../common/mixins/forms/types.js").FormAssociatedElementInterface> & import("../common/mixins/constructor.js").Constructor<import("../common/mixins/event-emitter.js").EventEmitterInterface<IgcDatepickerEventMap>> & AbstractConstructor<IgcBaseComboBoxLikeComponent>;
/**
...
export default class IgcDatePickerComponent extends IgcDatePickerComponent_base {
    ...
    protected renderPicker(id: string): import("lit-html").TemplateResult<1>;
    private renderLabel;
    private renderHelperText;
    protected renderInput(id: string): import("lit-html").TemplateResult<1>;
